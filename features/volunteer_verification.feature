...
Scenario: verify volunteer information
  ...
  Then I go to the confirm page/spreadsheet
  Then I review volunteer information
  And I confirm volunteer information    # does this involve persisting a flag indicating confirmation?
  Then I should see volunteers assigned to a position at an event
